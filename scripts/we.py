...
# dedup("Hello what is this function")
# Output: ['H', 'e', 'l', 'o', ' ', 'w', 'h', 'a', 't', 'i', 's', 'f', 'u', 'n', 'c']
...
def safe_word(w):
    ...
    # "^[a-z_]*$" = use template "^ *$" and put regex expression inside
    # [a-z_] means in the a-z range and _ means a "_" character
    # _ means a "_" character
...
def load_professions():
    os.chdir("c:\\Users\\LONCB47\\repo\\nlp_bias")
    # File path of the json file
    professions_file = os.path.join('c:\\Users\\LONCB47\\repo\\nlp_bias\\debiaswe', 'data', 'professions.json')
    # Read json files
